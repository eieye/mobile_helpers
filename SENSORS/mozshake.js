...
/** (PART OF) CUSTOM SHAKE_EVENT "MOZ SLIDERS FLASH" // MON 25-APR-22 */
/** "CAPS" COMMENTS BY ME */
/** (INCLUDING "Z"-AXIS MIGHT BE TOO SENSITIVE FOR WRITING) ##OK## */
...
(function(global, factory) {
    ...
    function Shake(options) {
        //feature detect
        this.hasDeviceMotion = 'ondevicemotion' in window; 												// "IN"-OP RETURNS T/F FOR PROP IN PROTO/CHAIN
